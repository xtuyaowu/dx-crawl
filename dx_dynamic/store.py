...
class DxStore:
    ...
    # dx_product
    def insert_sku(self, _uuid, products_id, brand, product_url, _name, first_title, second_title, original_price,
        ...
        sql = "insert into scb_crawler_global_sku(scgs_uuid, scgs_products_id, scgs_brand, scgs_product_url, scgs_name," \
              ...
              "scgs_tags, scgs_shop_url)values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        cur = self.conn.cursor()
        cur.execute(sql, (_uuid, products_id, brand, product_url, _name, first_title, second_title, original_price,
                          price, discount, dispatch, shipping, currency, attribute, version_urls, review_count, grade_count,
                          image_url, extra_image_urls, category, category_url, category_id, platform, platform_url, status, crawl_time, create_time,
                          description, tags, shop_url))
        self.conn.commit()
